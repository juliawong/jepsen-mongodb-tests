...
(defn ^MongoCollection with-read-preference
  "Returns a copy of the given collection, using the given read preference
  "
  [^MongoCollection coll]
  ; (.withReadPreference coll (ReadPreference/primary)))
  (.withReadPreference coll (ReadPreference/nearest)))
